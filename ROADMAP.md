...
4. User edits manifest (rename Dashboard → "Inspector view"), approves
5. Optional style reference: types "based on linear.app aesthetic"
6. Design agent generates 3 variants per page in parallel
7. User picks one variant per page
8. Click Implement All → project scaffolds with all picked designs as starting code
9. Workspace opens with running preview matching the picked designs
